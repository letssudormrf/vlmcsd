...
typedef struct VlmcsdHeader
{
	...
	union
	{
		...
		struct
		{
			...
			union
			{
				uint64_t EPidWindowsOffset;
				char* EPidWindows;
			};

			union
			{
				uint64_t EPidOffice2010Offset;
				char* EPidOffice2010;
			};

			union
			{
				uint64_t EPidOffice2013Offset;
				char* EPidOffice2013;
			};

			union
			{
				uint64_t EPidOffice2016Offset;
				char* EPidOffice2016;
			};
		};
	};
